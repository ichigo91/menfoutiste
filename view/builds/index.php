<div id="request_tmp" style="display:none"></div>
...
<div class="row">
  <div class="col align-self-center text-center">
    <a class="btn btn-primary" href="<?php echo Router::url('builds/user_index'); ?>" role="button">Ajouter un build</a>
  </div>
</div><br>
<?php //echo $this->Pagination->pagination($this->request->page,$page); ?>
...
<script src="<?php echo Router::webroot('js/find.js'); ?>"></script>