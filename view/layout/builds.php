...
<html xmlns="http://www.w3.org/1999/xhtml" xml.lang="fr" lang="fr">
			...
			<div class="row">
				<div class="col-4"></div>
  				<div class="col-4 align-self-center text-center">
  					<input type="text" class="form-control" id="find" onkeyup="chrono=setTimeout('find()', '500')" onkeydown="down()" value="" placeholder="Rechercher par héros..." aria-label="Rechercher par héros..." aria-describedby="button-addon2">
				</div>
			</div><br>
	...
	<script type="text/javascript">
		function showSpan(id){
			var all = document.getElementsByClassName('builds');
